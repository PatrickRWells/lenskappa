...
class csvOutputHandler(outputHandler):
    ...
    def __init__(self, path: Path, parser: parser.lenskappaOutputParser, columns: List[str], *args, **kwargs):
...
class MultiCsvOutputHandler(outputHandler):
    ...
    def __init__(self, paths: dict, parsers: Union[dict, parser.lenskappaOutputParser], columns: Union[dict, List[str]], *args, **kwargs):
